...
def main():
    ...
    parser.add_argument('--method', default='v1', choices=['v1', 'v2', 'v3', 'v4', 'v5'],
                       help='Detection method: v1 (Hough circles), v2 (optimized template matching), v3 (fast hybrid), v4 (advanced hough), or v5 (placeholder)')
